...
class ParticipacionEventoDAO {
    ...
    public function agregarParticipacion($id_usuario, $id_evento) {
        // La tabla participacion_evento se relaciona directo con usuario_id,
        // no existe columna corredor_id (ver estructura real de la tabla).
        $sql = "INSERT INTO participacion_evento (usuario_id, evento_id) VALUES (?, ?)";
        $params = [(int)$id_usuario, (int)$id_evento];
